...
# Хичээл 5 — 🎮 Anime Guesser тоглоомоо бүтээх + JSON-той танилцах
...
> 🎮 **Эхлээд өөрөө тоглогч бол!** Багш 2-3 emoji таавар асууна: `🏴‍☠️🍖👒`? `🍥🍜🦊`? … Таасан уу? Тэгвэл — **одоо чи ийм таавруудыг ӨӨРӨӨ үүсгэнэ.**
...
## 🎲 Алхам 1 — Тоглоомынхоо дүрмийг зохио (эхлээд!) · ⏱️ ~5 мин
...
Энэ дүрмийн дагуу тоглоомын жагсаалтанд нэмж байршуул.
```

> 💡 Тоонуудаа (15 сек, 3 амь, +10) өөрчилбөл тоглоом шал өөр мэдрэмжтэй болно.

> ✅ **Шалгая:** 2 горимоо тоглоход дүрэм (хугацаа, амь, оноо) ажиллаж байна уу?

---

## 🎨 Алхам 2 — Тоглоомоо "амьд" болго · ⏱️ ~10 мин
...
> ✅ **Шалгая:** Зөв хариулахад НОГООН, буруу бол УЛААН болж байна уу?

---

## 📦 Алхам 3 — Датагаа алхам алхмаар бэлдэх · ⏱️ ~20 мин
...
**✍️ Эхлээд ГАРААР бөгл** (JSON бол зүгээр л карт — эхлээд цаасан дээр зуръя):
...
> 💡 Одоо ЯГ ЭНЭ картаа доорх JSON болгож "орчуулна". `{ }` = нэг карт, талбар бүр = нэг мөр.
...
## 🚀 Алхам 4 — Турших → Publish → Хуваалцах · ⏱️ ~10 мин
...
> 🏆 **Тоглоом солилцох тэмцээн!** Хос бүр _хажуугийн хосын_ тоглоомыг тоглоно. Хамгийн олон оноо аваад ирсэн нь ялна! Өөр хүн тоглоход нуугдсан алдаа шууд илэрдэг — хамгийн шилдэг тест энэ. 😎
...
### ⚡ Түрүүлж дуусвал — баяжуулах нэмэлт санаанууд

![Дата баяжуулах](images/03-data-bayajuulah.svg)

Хугацаанаасаа өмнө дуусвал эдгээрийн нэгийг туршаад үз (бүгд яг л шинэ дата нэмэх замаар):
