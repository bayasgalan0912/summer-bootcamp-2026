...
# Хичээл 12 — 🦸 Баатар таах горим + 🏆 Оноогоо хадгалах (Firestore)
...
- **Хичээл 11-ийн гэрийн даалгавраар эхлүүлсэн бол** → горимоо ажиллуулж, баатар нэмж сайжруул.
...
```text
Аниме таах тоглоом дээр оноо хадгалах боломжтой болго.
Тоглоом дуусахад нь тоглогчийн нэр + оноо + асуултын хариуг Firestore-ийн "scores" collection-д хадгалаач.
Онооны жагсаалтыг харах боломжтой байх ёстой
```
