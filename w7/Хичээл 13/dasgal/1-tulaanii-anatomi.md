...
# 🥊 ХЭСЭГ 1 — Тулааны тоглоомын анатоми · ⏱️ ~10 мин

> 🎯 **Зорилго:** Тулааны тоглоом яг ЮУНААС бүтдэгийг тайлж, өнөөдөр юу хийхээ шийдэх.

> ⚠️ Энэ 10 минут дараагийн 2 хичээлийг бүхэлд шийднэ.

---

<details open>
<summary>👀 <b>Дасгал 1.1 — Жинхэнэ Street Fighter-ийг АЖИГЛА</b> · ⏱️ ~4 мин</summary>

### 🕹️ <a href="https://www.retrogames.cz/play_304-SNES.php" target="_blank">1991 оны жинхэнэ Street Fighter II-ыг браузераасаа тогло 🔗</a>

> 🎮 **Товч:** `←` `→` явах · `A` `S` `D` цохих, өшиглөх · `Enter` эхлүүлэх
> _(Товч ажиллахгүй бол тоглоомын дэлгэц дээр нэг дар — фокус авна.)_

**2 минут тогло. Дараа нь 2 минут АЖИГЛА** — энэ удаа хожих гэж бүү оролд, зөвхөн **хар**:
...
<details>
<summary>🧍 <b>Дасгал 1.2 — Дүр бол "ТӨЛӨВ"-үүдийн жагсаалт</b> · ⏱️ ~3 мин · 🔑 гол ойлголт</summary>
...
🔍 **Буцаж 1.1-ийн тоглоом руу ор** — Ryu-г 10 секунд ажиглаад **төлөв бүрийг нь нэрлэ**: одоо `idle`… одоо `walk`… одоо `punch`… одоо `hit`!
...
<details>
<summary>🧩 <b>Дасгал 1.3 — Тоглоомын 3 хэсэг (танил зүйл!)</b> · ⏱️ ~2 мин</summary>

Хичээл 11-д сурсныг сана — тоглоом **3 хэсгээс** бүтдэг:
...
> 💡 Хичээл 11-д дата бол **асуулт-хариулт** байсан. Одоо дата бол **зургийн хаягууд**. JSON нь ижил — агуулга л өөр!
...
<details>
<summary>🗺️ <b>Дасгал 1.4 — 3 хичээлийн зам</b> · ⏱️ ~2 мин</summary>

![3 хичээлийн зам](../images/06-3-hicheeliin-zam.svg)

| Хичээл          | Гол зүйл                                  | Дуусахад чи...                        |
| --------------- | ----------------------------------------- | ------------------------------------- |
| **13 (өнөөдөр)** | 🎨 Дүр, арт, анимаци, арена                | idle хөдөлж, 1 цохилт ажиллана        |
| **14**          | 🥊 Жинхэнэ тулаан — combo, block, дуу      | Хоёулаа тулалдаж KO болно             |
| **15**          | 🏆 Дүр сонгох, best-of-3, leaderboard      | **Ангийн чемпионат** болно            |

> 🛡️ **3 хичээлийн гол дүрэм:** _"Ажиллаж байгааг бүү эвд."_ Нэг зүйл нэм → турш → дараагийнх. Хичээл 11-д сурсан дүрэм — одоо бүр чухал, учир нь одоо зураг, анимаци, дүрэм гэсэн 3 зүйл зэрэг байна.
...
- [ ] `sprites.json` бол Хичээл 11-ийн JSON-ий шинэ хэлбэр гэдгийг ойлгосон
