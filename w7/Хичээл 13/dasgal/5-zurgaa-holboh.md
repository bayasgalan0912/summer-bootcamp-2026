...
> 💡 Хичээл 11-д асуулт-хариултаа JSON болгосон. Одоо **зургийн хаягуудаа** JSON болгоно. Ижил ур чадвар — өөр агуулга.
...
> 💡 Хичээл 11-д Wikipedia-аас зургийн хаяг авсныг сана — яг ижил зарчим. Гэхдээ одоо зураг **өөрийнх** учир **өөрөө** интернэтэд тавина.
...
> 💡 **`walk` хийгээгүй бол** тэр мөрийг **бүрэн ав** (хагас үлдээвэл JSON эвдэрнэ). `kick`, `block` бол **хоосон array** `[]` — Хичээл 14-д дүүргэнэ.
...
### 🧠 Бүтцийг ойлго (Хичээл 11-ийн JSON!)
...
> 🔑 **Яагаад `punch` дотор ердөө 1 зураг байсан ч `[ ]` array вэ?** Хичээл 14-д punch-д 2-3 frame нэмнэ. Одооноос array байвал тэр үед **кодоо өөрчлөх шаардлагагүй** — зөвхөн дата нэмнэ. Энэ бол жинхэнэ програмчлагчийн бодох арга: 🧠 **"код = дүрэм, дата = агуулга"**.
...
> 🚨 **Цаашаа явахгүй!** 🔴 байвал тоглоом ажиллахгүй. Хамгийн түгээмэл: хаягийн хооронд **таслал алга**, эсвэл **сүүлийн таслал илүү** (trailing comma). Хичээл 11-ийн дасгалаа сана 😉
