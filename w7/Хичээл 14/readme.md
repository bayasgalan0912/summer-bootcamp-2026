# Хичээл 14 — Тулааны тоглоом #2: Sprite sheet, төлөв, хитбокс, дуу

> **Өнөөдөр:** Хичээл 13-ын аренаг **жинхэнэ тулаан** болгоно — kick, block, суулт, үсрэлт, frame тутмын цохилтын бүс, дуу чимээ, хөгжим.

**Урьдчилсан нөхцөл:** Хичээл 13-ын тоглоом ажиллаж байх ёстой (idle · walk · punch · hit · арена). Ажиллахгүй бол Алхам 1-д багшийн нөөц багцыг ав.
...
> Хичээл 13-д frame бүр **тусдаа PNG** байсан. Өнөөдөр тэднийг **sprite sheet** болгоно — жинхэнэ тоглоомууд ингэдэг.
...
**AI limit дуусав** → Хичээл 13-ын дүрэм: шаардлагаа 1 мессежид нэгтгэ · гарсан зургаа тэр даруй хадгал · Gemini ⇄ AI Studio сэлгэ · хосын нөгөө хаягаар үргэлжлүүл.
...
2. **Combo** — J → J → L дарааллыг 400ms дотор амжвал 3 дахь цохилт 1.5 дахин хүчтэй болно. (Хичээл 15-д ашиглана.)
...
**Дараагийн хичээл:** Хичээл 15 — 2 тоглогч, чемпионат, leaderboard (Хичээл 12-ын Firestore).
