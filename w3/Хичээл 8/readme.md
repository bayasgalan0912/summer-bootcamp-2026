...
- Frame бүрийн **яг таг хэмжээ**: 4:3, эх зураг 1024×768, дараа нь 256×192
...
- Дэвсгэр цэвэрлэх → бүгдийг **256×192** болгож жигдлэх → нэг мөрөнд угсрах
...
- Хуучин JSON → шинэ бүтэц: `sheet` · `frames` · `fps` · `loop` · `hold`
...
**Анимаци эхлээд гацна / хагас frame харагдана** → Sprite sheet-ийн нүдний хэмжээ JSON дахь `cell`-тэй таарахгүй байна. Sheet-ийн өргөнийг frame-ийн тоонд хуваа: `1024 ÷ 4 = 256` ✅. Бутархай гарвал sheet буруу угсарсан (Алхам 2.3).

**Дүр frame солиход хажуу тийш үсэрнэ** → Эх зургууд өөр өөр хэмжээтэй байна. Бүгдийг **256×192** болгож жигдлэ (Алхам 2.2).
...
| **Cell / нүд** | Sheet доторх нэг frame-ийн талбай (бидэнд 256×192) |
